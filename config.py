...
DATA_FILE_STEM = "测点11_003"  # 未使用降噪数据时读取的原始数据文件名前缀
...
GLOBAL_RESULT_PATH = "inversion_result_global.json"  # 全局优化结果的保存文件名
DLS_GLOBAL_INIT_PATH = GLOBAL_RESULT_PATH  # DLS 读取全局优化初始模型的文件名
DLS_LINESEARCH_INITIAL_STEP = 1.0  # DLS 线搜索首先尝试的模型更新步长
