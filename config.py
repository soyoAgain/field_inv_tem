# ---- Data source ----
SOURCE_DATA_PATH = '/Users/xiechushu/project/EM_app/TEM_app/data/sy6/测点2'  # 测点原始及降噪数据所在目录
TARGET_POINT = "测点2"  # 当前处理的测点名称，用于日志及结果文件元数据
...
# todo:TIME_GATE_START、Vobs_SCALE_FACTOR和TIME_GATE_END读取TARGET_POINT在/Users/xiechushu/project/EM_app/TEM_field_forward/point11/point_params.json的数值


TIME_GATE_END = 20e-3  # 对数抽道终止时刻，相对脉冲起点，单位 s
TIME_GATE_COUNT = 64  # 起止时刻之间的对数等间隔抽道数量
Vobs_SCALE_FACTOR = 1e-3 # 对感应电压的缩放系数
# ---- Jacobian ----
